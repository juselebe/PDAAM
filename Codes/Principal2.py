...
def VAScalc(H,W,T,W_shell,W_fiber,T_layer,N_floor,N_ceiling,N_solid,N_infill,N_fiber):
    """
    ...
    E=1.7 #Matrix young modulus MPA
    ...
    ##Capas de refuerzo 70000 MPa for Fiberglass 200000 for carbon fiber
    Engfiber=mic.mechcar(200,1.7,0.3,0.1,0.39)#Ef,Em,V_f,nu_f,nu_m values for fiberglass 19890,940,0.33,0.1,0.39
    def stiff(a):
    ...
    Triangulillo=1-Engfiber[6]**2*Engfiber[1]/Engfiber[0]
...
print(VAScalc(150,15,2,2.5,12.5,0.125,5,5,0,0,6))
